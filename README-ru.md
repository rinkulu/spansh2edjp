...
Подходит для нейтронного и галактического навигаторов.
...
Вы можете отключить эту функцию. В таком случае приложение сгенерирует подставные координаты, сохраняя настоящие расстояния между системами и количество прыжков между хопами (для нейтронного навигатора; в галактическом это значение всегда предполагается равным 1). Учтите, что некоторые функции EDJP в таком случае могут работать некорректно; на следование маршруту, впрочем, это повлиять не должно.
